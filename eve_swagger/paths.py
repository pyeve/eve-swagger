...
def add_parameters_dr(rd, parameters):
    ...
    if lookup_field:
        ...
        if "data_relation" in rd["schema"][lookup_field]:
            ...
            parameters.append(
                get_ref_parameter(app.config["DOMAIN"][dr["resource"]])
            )
    ...
    r = OrderedDict(
        [
            ...
            (
                ...
                {
                    "200": {
                        "description": "%s document fetched successfully"
                        % title,
                        "content": {
                            # TODO what about other methods?
                            "application/json": {"schema": get_ref_schema(rd)}
    ...
    r = OrderedDict(
        [
            ...
            (
                ...
                {
                    "200": {
                        "description": "%s document replaced successfully"
                        % title
                    },
                    "default": get_ref_response("error"),
                },
    ...
    r = OrderedDict(
        [
            ...
            (
                ...
                {
                    "200": {
                        "description": "%s document updated successfully"
                        % title
                    },
                    "default": get_ref_response("error"),
                },
    ...
    r = OrderedDict(
        [
            ...
            (
                ...
                {
                    "204": {
                        "description": "%s document deleted successfully"
                        % title
                    },
                    "default": get_ref_response("error"),
                },
...
def id_parameter(rd):
    return {
        "$ref": "#/components/parameters/{0}_{1}".format(
