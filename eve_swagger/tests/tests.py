...
class TestEveSwagger(TestBase):
    ...
    def test_parameters_people(self):
        ...
        self.assertIn(
            item_title + "_" + lookup_field, components["parameters"]
        )
    ...
    def test_field_description(self):
        ...
        self.assertEqual(
            "the last name of the person", props["name"]["description"]
        )
    ...
    def test_disabled_resource(self):
        ...
        self.assertNotIn(
            "/%s/{%sId}" % (url, item_title.lower()), doc["paths"]
        )
    ...
    def test_reference_to_data_relation_source_field(self):
        ...
        self.assertEqual(
            "#/components/schemas/%s" % key, people_props["job"]["$ref"]
        )
    ...
    def test_cors_with_origin(self):
        ...
        r = self.test_client.get(
            "/api-docs", headers={"Origin": "http://example.com"}
        )
